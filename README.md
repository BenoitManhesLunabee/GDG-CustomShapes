# GDG-CustomShapes
## Annexes
### Create a custom shape tutoriels
...
### Create a custom shape from svg
https://blog.devgenius.io/custom-shapes-in-jetpack-compose-deep-dive-b987a52c743c
https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/d
### Project to play with path (and a lot of compose things)
https://github.com/SmartToolFactory/Jetpack-Compose-Tutorials/blob/master/README.md#6-1-4-canvas-path-ops
### RoundPolygon & morphing
